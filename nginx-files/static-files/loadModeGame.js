...
<h2 data-i18n-key="game-mode">Create room</h2>
    <div class="row">
        ...
        <p data-i18n-key="mod-tourn" style="color: blue; font-size:1.6rem;">Tournament</p>
        </a>
        </div>
        ...
        <p style="color: blue; font-size:1.6rem;">Online</p>
        </a>
        </div>
        ...
        <p style="color: blue; font-size:1.6rem;">Local</p>
        </a>
        </div>
    </div>
<div>
